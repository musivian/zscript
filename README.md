...
```apt-get update && apt-get -y upgrade && apt-get -y autoremove && wget https://raw.githubusercontent.com/musivian/zscript/master/server.sh -O server.sh && bash server.sh ```<br>
